...
namespace ControllerMenuTest
{
    ...
    {
        public enum TitleScreenButtons
        {
            Start,
        }
        ...
        List<IController<TitleScreenButtons>> Controllers = new List<IController<TitleScreenButtons>>();

        public ControllerUtility()
        {
            for (int i = 0; i < Microsoft.Xna.Framework.Input.GamePad.MaximumGamePadCount; i++)
                Controllers.Add(new SimpleGamepad<TitleScreenButtons>(i)
                {
                    Map = new Controller<TitleScreenButtons, SimpleGamepad<TitleScreenButtons>.SimpleGamepadButtons>.ActionMap[]
                    {
                        new Controller<TitleScreenButtons, SimpleGamepad<TitleScreenButtons>.SimpleGamepadButtons>.ActionMap(TitleScreenButtons.Start, SimpleGamepad<TitleScreenButtons>.SimpleGamepadButtons.A),
                        new Controller<TitleScreenButtons, SimpleGamepad<TitleScreenButtons>.SimpleGamepadButtons>.ActionMap(TitleScreenButtons.Start, SimpleGamepad<TitleScreenButtons>.SimpleGamepadButtons.Start),
                    }
                });

            Controllers.Add(new KeyboardController<TitleScreenButtons>()
            {
                Map = new Controller<TitleScreenButtons, Microsoft.Xna.Framework.Input.Keys>.ActionMap[]
                {
                    new Controller<TitleScreenButtons, Microsoft.Xna.Framework.Input.Keys>.ActionMap(TitleScreenButtons.Start, Microsoft.Xna.Framework.Input.Keys.Enter),
                    new Controller<TitleScreenButtons, Microsoft.Xna.Framework.Input.Keys>.ActionMap(TitleScreenButtons.Start, Microsoft.Xna.Framework.Input.Keys.Space),
                }
            });
        }

        public IController<TitleScreenButtons> GetController()
        {
            foreach (var c in Controllers)
            {
                c.Update();

                if (c.IsActionPressed(TitleScreenButtons.Start))
                    return c;
            }
